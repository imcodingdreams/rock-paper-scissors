...
//         return gameResults.innerText = "The user won!";
//       }
//     } else {
...
// function functionRock() {
//   // 1 save the user choice in a variable (rock, paper, scissors)
//   let userChoice = rockChoice;
//   // 2 randomly create a computer choice (rock, paper or scissors)
//   // 3 save the computer choice in a variable
//   // 4 display the user choice
//   userChoice.innerText = "The user chose rock";
//   // 5 display the computer choice
//   // 6 calculate whether user has won, lost or tied
//   // 7 update the user score
//   // 8 update the computer score
// }
// functionRock();